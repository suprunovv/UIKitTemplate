...
final class SmsViewController: UIViewController {
    ...
    private let descriptionSmsLabel: UILabel = {
        ...
        label.font = Constants.verdana16
    ...
    private let smsTextField: UITextField = {
        ...
        textField.font = Constants.verdanaBold18
    ...
    private func configureUI() {
        ...
        backButton.image = Constants.backButton
    ...
    @objc private func confirmButtonTapped() {
        ...
        thankViewController.mainNavigationController = navigationController
        thankViewController.modalPresentationStyle = .fullScreen
        present(thankViewController, animated: false, completion: nil)
    }
}
